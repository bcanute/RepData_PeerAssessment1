...
```{r hist1, echo = TRUE, fig.keep = 'all'}
...
#### Code
```{r plot2, echo = TRUE, fig.keep = 'all'}
###Make a time series plot (i.e. type = "l") of the 5-minute interval (x-axis) and the average number of steps taken, averaged across all days (y-axis)
...
On average, the interval at `r max_mean_steps$Group.1` was the most active with an average of `r max_mean_steps$x` steps in 5 minutes, possibly when the subject was running to catch the bus??????
...
#### Code
```{r hist2, echo = TRUE, fig.keep = 'all'}
...
```{r combined_plot, echo = TRUE, fig.keep = 'all'}
